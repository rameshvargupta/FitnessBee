      ...
      <div className="MainComponent RespComponent">
        ...
        <div className="SelectMainImg pb-5">
          ...
          <div className="Image">
            ...
            <img className='img-fluid' src="./Images/Home/FIDimg2.jpg" alt="" />

          </div>

          <div className="imagesDetails">
            <p><a target='blank' href="https://drive.google.com/file/d/1LGfk8gnTg3Pb0yozhl_VE5on4F65as7_/edit">Download</a> | GDrive | High Resolution .PDF | 8Mb</p>
            ...
            <p>A paperback option is available from any local bookstore or from <a target='blank' href="https://www.amazon.com/dp/1844811557/">Amazon.com</a>, <a target='blank' href="https://www.amazon.de/dp/1844811557/">Amazon.de</a> or <a target='blank' href="https://www.amazon.co.uk/dp/1844811557">Amazon.co.uk</a>. Paperbacks always contain the same information already available for free on this resource. It is also an easy way to introduce someone else to bodyweight training offline. When you buy a paperback you pay for printing and store fees, DAREBEE only makes $1 from each sale. That money goes directly into our development and maintenance fund.</p>
